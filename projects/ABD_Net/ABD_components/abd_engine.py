...
class ImageABDEngine(Engine):
    ...
    def train(
        ...
        for batch_idx, data in enumerate(self.train_loader):
            ...
            loss_t = self._compute_loss(self.criterion_t, outputs[1], pids)
            loss_x = self._compute_loss(self.criterion_x, outputs[2], pids)
